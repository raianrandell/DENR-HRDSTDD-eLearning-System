...
function getAllTrainings($conn) {
    $sql = "SELECT training_id, training_title, description, start_date, end_date FROM training";
...
if (isset($_GET['trainingID']) && !empty($_GET['trainingID'])) {
    ...
    if ($trainingDetails) {
        ...
        echo "Training not found."; // Or handle the case where training is not found
        exit();
    }
}
