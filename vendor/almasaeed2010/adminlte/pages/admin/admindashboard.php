...
function getMonthlyParticipants($conn, $year, $filterMonths = []) {
    $sql = "SELECT MONTH(created_at) AS month, COUNT(*) AS participant_count FROM user_participants WHERE YEAR(created_at) = ?";
...
$monthly_counts = getMonthlyParticipants($conn, $selectedYear, $selectedMonths);
