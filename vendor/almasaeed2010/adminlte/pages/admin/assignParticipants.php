        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form id="assignParticipantsForm" action="processAssignParticipants.php" method="post">
                    ...
                    <a href="training.php" class="btn btn-outline-secondary rounded-0">Cancel</a>
...
<script>
    $(document).ready(function () {
        ...
        // Alert if only one participant is available
        <?php if ($num_participants === 1): ?>
            Swal.fire({
                title: 'Attention',
                text: 'Only one participant is available to assign to this training.',
                icon: 'info',
            });
        <?php endif; ?>
