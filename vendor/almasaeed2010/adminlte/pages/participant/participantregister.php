    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="process_participant_registration.php" method="POST" enctype="multipart/form-data">
                <div class="group">
                    <input type="file" class="input" name="photo" accept="image/*" placeholder=" ">
                    <span class="bar"></span>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="group">
                            <input required type="text" class="input" name="first_name" placeholder=" " autofocus>
                            <span class="bar"></span>
                    ...
                    <div class="col-md-6">
                        <div class="group">
                            <input type="text" class="input" name="middle_name" placeholder=" ">
                            <span class="bar"></span>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="group">
                            <input required type="text" class="input" name="last_name" placeholder=" ">
                            <span class="bar"></span>
                    ...
                    <div class="col-md-6">
                        <div class="group">
                            <input required type="email" class="input" name="email" placeholder=" ">
                            <span class="bar"></span>
                            <label>Email *</label>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="group">
                            <input type="tel" class="input" name="contact_number" pattern="[0-9]{11}" maxlength="11" placeholder=" ">
                            <span class="bar"></span>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="group">
                            <select required class="input" name="gender">
                    ...
                    <div class="col-md-6">
                        <div class="group">
                            <input required type="number" class="input" name="age" placeholder=" ">
                            <span class="bar"></span>
                            <label>Age *</label>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="group">
                            <input type="text" class="input" name="office" placeholder=" ">
                            <span class="bar"></span>
                            <label>Office</label>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="group">
                            <input type="number" class="input" name="salary_grade" placeholder=" ">
                            <span class="bar"></span>
                ...
                <div class="group">
                    <input type="text" class="input" name="position" placeholder=" ">
                    <span class="bar"></span>
